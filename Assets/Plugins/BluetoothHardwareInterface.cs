...
#elif UNITY_ANDROID
				Debug.Log(proximityUUIDsString);
				if (_android != null)
					_android.Call ("androidBluetoothScanForBeacons", proximityUUIDsString);
				// var iBeaconData = new iBeaconData();
				// iBeaconData.UUID = proximityUUIDsString;
				//
				// bluetoothDeviceScript.DiscoveredBeaconAction(iBeaconData);
#endif
			}
		}
